...
//                break;
    private static void customItems(int itemId) {
        ...
        itemDef.countObj = null; // custom items are not stackable!! this should be added to all items what have model ids missing otherwise it breaks shops
        switch (itemId) {
            case 21726:
            case 21728:
...
//				itemDef.groundActions[2] = "Take";
            ...
            case 21898:
                ...
                break;
            case 8167:
                itemDef.name = "@or2@Raids Rewards Chest";
            ...
            case 2841:
                ...
                break;
            case 26080:
                itemDef.name = "@red@Double Drop Rate";
                itemDef.interfaceOptions = new String[] { "@yel@Activate", null, null, null, "Drop" };
                break;
            case 21791:
            case 21793:
