...
public class Configuration {
	...
	public static final String CACHE_LINK = "http://xerosio.site.nfoservers.com/xerosv2/v0.049.zip";
	...
	public static final String TEST_SERVER_ADDRESS = "51.79.50.152";//51.79.50.152
